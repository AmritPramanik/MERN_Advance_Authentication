...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      />
      <div className="bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-200 text-small">
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          {state === "Login" && (
            ...
            className="mb-4 text-indigo-300 pl-1 cursor-pointer">
              Forgot password?
            </p>
          )}

          <button className="w-full py-2.5 rounded-full cursor-pointer bg-gradient-to-br from-indigo-400 to-indigo-900 text-white font-medium">
            {state}
          </button>
        </form>
